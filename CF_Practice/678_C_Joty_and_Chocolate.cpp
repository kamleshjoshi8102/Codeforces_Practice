...
void solve()
{
        ...
        ll cn=0;
  // n/ a will give numbers divisible by a similarly for b but for common I did n/lcm(a,b) because it will be least common multiple integer 
        cout<<(n/b)*q+(n/a)*p-min(p,q)*(n/lcm(a,b))<<en;
